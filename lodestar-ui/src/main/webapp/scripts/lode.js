...
(function($) {
    ...
    var appdetails = $("<div id='lodestar-description' class='ui-widget ui-corner-all'/>")
        .append($("<p></p>")
        .append($("<span id='app-details'>Generated by the <a href='http://ebispot.github.io/lodestar/'>Lodestar</a> linked data browser from the Functional Genomics Production Team (FGPT)</span>")));
